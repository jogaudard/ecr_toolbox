...
Editing the `emaillart_publications.qmd` file, you can make a list of publications in pdf (that gets updated everytime you render it) that can be downloaded from the CV webpage.

### Rendering


The repo now runs on targets, so you will just need to run the following code to render the CV in pdf and html, and the list of publications in pdf:
...
I don't expect you to cite this repo if you just use it to make your CV webpage.

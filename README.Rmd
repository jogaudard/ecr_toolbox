...
It is easy to update, it is always available, and lists of publications can be automated.
...
Create a quarto file named `index.qmd` (you can download the one from the example).
Fill in the information in the yaml, gather your degrees and publications, and let's get started!
...
- Have your slides on your phone (true story: I redid my presentation to some important people who had missed it on the U1 at 23:00 from my phone slides.)
